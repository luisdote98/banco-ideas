...
function buildExportText(ideas: Idea[]): string {
  ...
  const lines: string[] = [
    `IDEAS — ${new Date().toLocaleDateString("es-ES", { day: "numeric", month: "long", year: "numeric" })}`,
    `Total: ${ideas.length} idea${ideas.length !== 1 ? "s" : ""}`,
    "",
    "Hola Claude, estas son mis ideas. Por favor, para CADA idea:",
    "1. Mejora el título si es necesario",
    "2. Desarrolla la información en secciones claras (contexto, detalles relevantes, correcciones, etc.)",
    "3. Termina SIEMPRE con el próximo paso concreto",
    "4. Si hay imagen adjunta, tenla en cuenta",
    "",
    "MUY IMPORTANTE — usa EXACTAMENTE este formato para cada idea (sin variaciones):",
    "",
    "IDEA N — [Título mejorado]",
    "Estado: [Sin realizar / Activa / En proceso]",
    "",
    "[Aquí escribe toda la información desarrollada, en párrafos o secciones con el nombre que quieras]",
    "",
    "Próximo paso:",
